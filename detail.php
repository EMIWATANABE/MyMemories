    ...
    <div class="container">
      <div class="main-contents">
        <div class="col-lg-10 col-lg-offset-1 centered">
          <div class="col-xs-4">
            <a href="" class="trim"><img class="picture" src="<?php echo $feed['img_name']; ?>" alt=""></a>
          </div>
          <div class="col-xs-8">
            <div class="details">
              <h3 class="post-title"><?php echo $feed['title']; ?></h3>
              <h4 class="post-date"><?php echo $feed['date']; ?></h4><br>
              <h3 class="post-detail"><?php echo $feed['detail']; ?></h3>
            </div>
          </div>
        </div>
      </div>
